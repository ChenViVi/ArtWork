...
public class tls_sigature {
	...
	public static final String pubStr = "-----BEGIN PUBLIC KEY-----\n"+
			"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAErnI3EDgq5zVgEYb0GpwT33ogBnL+\n"+
			"Oz1IpxMhKBRsOz9aGgEJ5BkW+F/8X+KYWAWXDyqloWZQmQLJWctkU4kB/w==\n"+
			"-----END PUBLIC KEY-----";
	...
	public static void main(String[] args) {
		try{			
            ...
            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400077891, "792585582@qq.com", privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400077891, "792585582@qq.com", pubStr);
			...
			String publicKey ) throws DataFormatException
	{
		...
		String sigTLS = null;
		String sigTime = null;
		String sigExpire = null;
		try {
			JSONObject jsonObject= new JSONObject(jsonString);
			sigTLS = jsonObject.getString("TLS.sig");
			sigTime = jsonObject.getString("TLS.time");
			sigExpire = jsonObject.getString("TLS.expire_after");
	...
	public static CheckTLSSignatureResult CheckTLSSignatureEx(
		...
		String sigTLS = null;
		String strSdkAppid = null;
		String sigTime = null;
		String sigExpire = null;
		try {
			JSONObject jsonObject= new JSONObject(jsonString);
			sigTLS = jsonObject.getString("TLS.sig");
			strSdkAppid = jsonObject.getString("TLS.sdk_appid");
			sigTime = jsonObject.getString("TLS.time");
			sigExpire = jsonObject.getString("TLS.expire_after");
		} catch (JSONException e) {
			e.printStackTrace();
